          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto">
              ...
              <div className="mb-3 pt-0">
                <Input type="text" variant="outlined" value={nameInput} onChange={(e) => setNameInput(e.target.value)} label="Item name" className="px-2 py-3 text-sm border-0"/>
              </div>

              <div className="mb-3 pt-0">
                <Input type="number" variant="outlined" value={quantityInput} onChange={(e) => setQuantityInput(parseInt(e.target.value))} label="Item quantity" className="px-2 py-3 text-sm border-0"/>
              </div>
            </div>
            {/*footer*/}
